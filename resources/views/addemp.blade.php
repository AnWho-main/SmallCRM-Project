...
<div class="container"><h2>Enter Employee Details:- </h2></div></br>
...
<div class="mb-3 row">
  ...
  <div class="mb-3 row">
    <label for="inputemail" class="col-sm-2 col-form-label">Company ID:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="companyname" id="companyname" value="" placeholder="Enter 1,2 or 3 only ">
    </div>
  </div>
